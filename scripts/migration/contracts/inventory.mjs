...
export const SOURCE_REVISION='13a97c065ee0c6be6733f11aa7fd4bbeb23cd212';
...
const INTERNAL_EXPORTS = new Set(['game.traffic.bridgeWaitingPoint']);
let oracle;
